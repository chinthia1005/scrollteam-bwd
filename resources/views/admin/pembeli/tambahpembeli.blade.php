            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Pembeli</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">App</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Pembeli</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Use contextual classes to color table rows or individual
                                    cells.</h6>
                                  <form action="/insertpembeli" method="post" class="mt-4" enctype="multipart/form-data">
                                    @csrf  
                                        ...
                                        <div class="form-group">
                                         ...
                                         <input name="Nama_Pembeli" type="text" class="form-control">
                                            ...
                                            <input nama="Jenis_Handphone" type="text" class="form-control">
                                        </div>
